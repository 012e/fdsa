...
from workflows.repository_ingestion import RepositoryIngestionWorkflow, RepoFileIngestionWorkflow
...
async def main():
    ...
    worker = Worker(
        ...
        workflows=[SnippetIngestionWorkflow, RepositoryIngestionWorkflow, RepoFileIngestionWorkflow],
        activities=[
            summarize_code,
            chunk_code,
            summarize_chunks,
